...
class FooterSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        '© 2025 Operation Summer. Built for families, by families.',
        textAlign: TextAlign.center,
...
class DashboardPage extends StatelessWidget {
  // This would be replaced by the actual app dashboard.
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Mission Dashboard'),
        backgroundColor: Color(0xFF2f3e46),
      ),
      // body: Center(child: Lottie.asset('assets/party.json', height: 200)),
    );
  }
}
